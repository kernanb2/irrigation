...
CREATE TABLE zones (
    ...
    local_index     TINYINT UNSIGNED NOT NULL,  -- 0–4 within the unit
    name            VARCHAR(64) NOT NULL,
    description     TEXT,
    valve_state     ENUM('open','closed') NOT NULL DEFAULT 'closed',
    last_state_change TIMESTAMP,
    enabled         BOOLEAN NOT NULL DEFAULT TRUE,
    is_special      BOOLEAN NOT NULL DEFAULT FALSE, -- creek/pond valves
    notes           TEXT,
...
CREATE TABLE moisture_readings (
    ...
    raw_value   SMALLINT UNSIGNED NOT NULL,   -- ADC 0–4095
    moisture_pct TINYINT UNSIGNED,            -- 0–100 after calibration
...
CREATE TABLE temperature_readings (
    id          INT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    unit_id     TINYINT UNSIGNED NOT NULL,
    sensor_addr VARCHAR(16) NOT NULL,  -- DS18B20 64-bit address as hex string
...
CREATE TABLE valve_events (
    ...
    initiated_by VARCHAR(64),  -- username or 'system'
...
CREATE TABLE schedules (
    ...
    zone_id         TINYINT UNSIGNED NOT NULL,
    name            VARCHAR(64),
    cron_expression VARCHAR(64) NOT NULL,  -- standard 5-field cron
    duration_sec    SMALLINT UNSIGNED NOT NULL,
    enabled         BOOLEAN NOT NULL DEFAULT TRUE,
    skip_if_moist   BOOLEAN NOT NULL DEFAULT TRUE,   -- skip if moisture_pct > skip_threshold
